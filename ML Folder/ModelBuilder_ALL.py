...
from settings import TRAIN_SPLIT, PREVIOUS_STEPS, TRAINING, VARIABLES, LIN_REG_VARS, MODEL_DIR, SCALER_DIR, DATA_DIR
...
# %%
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------
# 1. FUNCTION TO BUILD THE MODELS USING AUTO_KERAS_TUNER
...
def keras_parameter_tuning_builder(hp):
    ...
    # 1.1. DEFINING A SERIES OF HYPERPARAMETERS TO BE TUNED
    ...
    # 1.2. BUILDING OUR AUTOENCODER MODEL
...
# %%
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------
# 3. FUNCTION THAT BUILDS THE MODELS AND STORES THEM
...
def model_builder():
    ...
    for var_to_predict in VARIABLES:
        ...
        # If the variable is not as suitable for a linear regression model...
            ...
            # 3.4. RETRIEVING THE BEST MODEL AND FITTING IT TO OUR DATA
